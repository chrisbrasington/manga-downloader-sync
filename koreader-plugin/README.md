...
`manga-ereader-backend` container at `https://manga-api.home.chrisincode.com`.
...
2. First time: **Manga Library → Server address** — confirm it is
   `https://manga-api.home.chrisincode.com` (change if your setup differs).
